...
lexers.STYLE_CURSOR_PRIMARY = 'fore:'..colors.yellow..',back:'..colors.cursorbackground..',reverse'
lexers.STYLE_LINENUMBER_CURSOR = 'fore:'..colors.foreground..',back:'..colors.cursorline
lexers.STYLE_STATUS = 'fore:'..colors.background..',back:'..colors.foreground..',reverse'
lexers.STYLE_STATUS_FOCUSED = 'fore:'..colors.navy..',back:'..colors.background..',reverse'
lexers.STYLE_SEPARATOR = 'fore:'..colors.comment
lexers.STYLE_INFO = 'fore:'..colors.yellow..',bold'
