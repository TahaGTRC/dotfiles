...
// The commented line took a long time before starting up dmenu w/ a long (w emojis) input, using bh will prevent this calculation, and truncate the overflowing text (...)
#define TEXTW(X)              (min_width)
//(drw_fontset_getwidth(drw, (X)) + lrpad)

// This one for calculating the prompt size
